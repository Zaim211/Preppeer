    ...
    <div className="w-full p-12" style={{ backgroundColor: "#060724" }}>
      ...
      <div className="flex-1 p-6 justify-center">
        <img
          src={blogHero}
          alt="hero3"
          className="items-center h-[600px] object-contain"
        />
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-white p-12 max-w-12xl mx-auto">
          ...
          <p className="text-white text-2xl leading-12">
            Re-college summers can be stressful for both parents and high school
          ...
          <h1 className="text-secondary mb-4 text-4xl text-start mt-12">
            Why This Summer?
          </h1>
          ...
          <div className="mt-14">
            ...
            <ul className="list-disc pl-12 space-y-2 text-lg">
              ...
              <li>
                Selected for <span className="font-semibold">TechGirls</span>:
              ...
              <li>
                Launched <span className="font-semibold">Writerama</span>: A
              ...
              <li>
                Accepted into{" "}
                <span className="font-semibold">Lumiere Education</span>:
                Received mentorship from Harvard alum Stephen Turban.
              </li>
              <li>
                Spent Time in <span className="font-semibold">Singapore</span>:
                Stayed with a host family and friends.
              </li>
              <li>
                Learned to <span className="font-semibold">Cycle</span>:
          ...
          <div className="p-6  mt-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg mb-4 font-semibold mt-12">
                  Here are the values I identified after my reflection:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-lg">
                  <li>Learning and challenging myself academically</li>
