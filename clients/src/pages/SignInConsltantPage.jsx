...
const SignInConsltantPage = () => {
  const { setConsultant } = useContext(UserContext);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post('/api/SignInConsultant', { email, password });
      setConsultant(data);
...
export default SignInConsltantPage;
