...
//           <img src={Picture1} loading="lazy" alt="Picture 1" className="w-full h-auto object-contain mb-4 border-gray-100 shadow-2xl border rounded-lg"/>
...
//           <img src={Picture2} loading="lazy" alt="Picture 2" className="w-full h-auto object-contain mb-4 shadow-2xl rounded-lg"/>
...
//           <img src={Picture3} loading="lazy" alt="Picture 3" className="w-full h-auto object-cover shadow-2xl mb-4 rounded-lg"/>
