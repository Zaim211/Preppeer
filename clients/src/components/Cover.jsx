...
const Cover = () => {
  return (
    <div className=" bg-gray-200 text-center p-4 md:p-8">
      <h1 className="text-3xl md:text-4xl text-destructive font-bold mb-12">Why Us?</h1>
      <div className=" mb-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
        <div className="card flex flex-col items-center bg-gray-200 p-6 rounded-lg shadow-2xl transition-transform transform hover:scale-105 w-full max-w-sm">
        ...
        <div className="card flex flex-col items-center bg-gray-200 shadow-2xl p-6 rounded-lg transition-transform transform hover:scale-105 w-full max-w-sm">
        ...
        <div className="card flex flex-col items-center bg-gray-200 shadow-2xl p-6 rounded-lg transition-transform transform hover:scale-105 w-full max-w-sm">
          <img src={Picture3} alt="Picture 3" className="w-auto h-full object-contain shadow-2xl mb-4 rounded-lg"/>
